<?php
    ...
    if(isset($_POST['submit']) && $_POST['Barcode_ID'] != ''){
        ...
        if ($Taken_From == 1) {
            $Bags = (int)$_POST["M_Bags"];
            $Boxes = (int)$_POST["M_Boxes"];
            $Toute = (int)$_POST["M_Toute"];
            $Emp_Name = $_POST["M_Emp_Name"];
            $Lot_Num = $_POST["M_Lot_Num"];
            $Location_ID = (int)$_POST["M_Location_ID"];
                                    ...
                                    while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        if ($row['Lot_ID'] == $Lot_ID) {
                                            ...
                                            if($Expected_Weight != "" && $Expected_Weight <= $Weight){
                                                ...
                                                // echo "Is 114g <br/><br/>";
                                                $total_bags /= 4;
                                                $temp_w_stock = $Weight - ($Processed + $Garbage + $total_bags);
                                            }
                                            else{
...
<body onclick="removeSuggestion()">
                    ...
                    <form id='form_id' action="production.php" method="post" enctype="multipart/form-data">
                        ...
                        <table style="float:left">
                            <tr>
                                ...
                                <td>Expected Weigth:</td>
                                <td><input type="text" size="5" name="Expected_Weight" id="Expected_Weight" onchange="showGarbadgeValue(this.value)"/></td>
                            </tr>
                        </table>
    ...
    <script>
        ...
        function showGarbadgeValue(val) {
