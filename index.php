...
<body>
    <div class="sidebar" id = "sidebar_Id">
        <div class="search-box">
            <table>
                <tr>
                    <td><input type="text" name="search" placeholder="Search..." id="invoiceStatus_text" onchange="invoiceSpliter()"></td>
                    <td><input type="submit" value="GO" id="invoiceStatus_go"></td>
                </tr>
            </table>
        </div>
        <a href='index.php'><div class="menu highlight"><span class="icon-clipboard"></span><span>Dashboard</span></div></a>
    ...
    <div class="root" id="root_Id">
        ...
        <div class="note">
            <div class="toggle-btn" onclick="toggleNote()"><span class="icon-clipboard"></span></div>
            <div class="note-inner" id="note-inner">
        ...
        <div class="grid_container">
            <div class="grid item1">
                <div class="inside">
                    <div class="iitem">
                        <table>
                            <tr>
                                <td><label>Total Orders Today: </label></td>
                                <td><label id="today-order"></label></td>
                            </tr>
                        </table>
                    </div>
                    <div class="iitem">
                        <table>
                            <tr>
                                <td><label>Last Order: </label></td>
                                <td><label id="last-order"></label></td>
                            </tr>
                        </table>
                    </div>
                    <div class="iitem">
                        <table>
                            <tr>
                                <td><label>Total Orders This Month: </label></td>
                                <td><label id="total-this-month"></label></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="grid item2 table">
                ...
                <div class="info glossyTable" id="Extraction_Table"></div>
            </div>
            <div class="grid item3 graph">
                <div class="inside"><span>Graphical Representation :</span></div>
                <div class="details" id="invoice_content_div">
                    <canvas id="myChart" width="800" height="900"></canvas>
                </div>
            </div>
            <div class="grid item4">
                <div class="inside">
                    <span>Top Products</span>
                    <input type="text" style="width:auto" onblur="updateTopProductsAmount(this.value)"/>
                </div>
                <div class="details glossyTable" id="topProductsTable">
                </div>
            </div>
    ...
    <script>
        ...
        window.setInterval(function(){invoiceInfo();}, 10000);
    </script>
</body>
</html>